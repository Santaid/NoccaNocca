		...
		if(AIColor == GameMainScript.instance.Turn){
            ...
            if(Input.GetKeyDown("return")){
                ...
                if(inputField.text.Length == 4){
					from_x = int.Parse(inputField.text[0].ToString());
					from_z = int.Parse(inputField.text[1].ToString());
					to_x = int.Parse(inputField.text[2].ToString());
					to_z = int.Parse(inputField.text[3].ToString());
				}
				else{
					return;
				}
